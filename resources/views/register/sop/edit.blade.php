...
@section('breadcumb')
  {!!$back!!}
  <a href="{{url('register/sop')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary btn-icon-split rounded mr-1">
            ...
            <div class="card-body card-block">
              ...
              <div class="row m-auto d-flex">  
                <div class="form-group flex-fill mr-2">
                  ...
                  <div class="input-group">
                    <input type="text" name="tgl_sop" class="datepicker form-control form-control-sm" value="{{date('d F Y', $data->tgl_sop)}}" autocomplete="off">
                  </div>
                </div>
